...
@Component({
    ...
    templateUrl: 'app/ticket_history.component.html'
})
...
export class TicketHistoryComponent implements OnInit {
    ...
    fetchTickets() {
        this._ticketService.getTicketHistory().then(
            tickets => {
                // LOADING ANIMATION
                ...
                if (_.isEmpty(tickets)) {
                    console.log("There are no historical tickets");
                    return;
                }
                ...
                setTimeout(function() {
                    ...
                    $('#dataTables-ticketHistory').DataTable({
                        responsive: true,
                        order: [[ 2, "desc" ]]
                    });
                }, millisecondsToWait);
